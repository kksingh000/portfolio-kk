...
export type StackZone = "peak" | "upper" | "below-shallow" | "below-deep";
...
export const zoneMeta: Record<StackZone, { note: string; submerged: boolean }> =
  {
